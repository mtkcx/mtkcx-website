  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      const welcomeMessages = {
        en: "Hi! I'm your virtual assistant. I can help you with questions about our products, services, shipping, and more. How can I assist you today?",
        ar: "مرحباً! أنا مساعدك الافتراضي. يمكنني مساعدتك في الأسئلة حول منتجاتنا وخدماتنا والشحن والمزيد. كيف يمكنني مساعدتك اليوم؟",
        he: "שלום! אני העוזר הווירטואלי שלך. אני יכול לעזור לך עם שאלות על המוצרים, השירותים, המשלוחים שלנו ועוד. איך אני יכול לעזור לך היום?"
      };
