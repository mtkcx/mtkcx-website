            ...
            <section>
              ...
              <div className="bg-primary/5 p-6 rounded-lg border border-primary/10">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>{t('policies.shipping.order_processing')}: 1-3 {t('policies.shipping.business_days')}</li>
                  <li>{t('policies.shipping.shipping_time')}: 7-10 {t('policies.shipping.business_days')}</li>
                  <li>{t('policies.shipping.total_delivery')}: 1-2 {t('policies.shipping.weeks')}</li>
                </ul>
              </div>
            </section>
